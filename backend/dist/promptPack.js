...
exports.MASTER_SYSTEM_PROMPT = void 0;
exports.buildRankResumesPrompt = buildRankResumesPrompt;
exports.buildResumeParsePrompt = buildResumeParsePrompt;
exports.buildJobAnalyzePrompt = buildJobAnalyzePrompt;
exports.buildAutofillPlanPrompt = buildAutofillPlanPrompt;
exports.MASTER_SYSTEM_PROMPT = `
...
`;
function buildRankResumesPrompt(params) {
    const payload = {
        task: 'RANK_RESUMES',
    ...
    return `${exports.MASTER_SYSTEM_PROMPT}\nReturn ONLY valid JSON.\nInput:\n${JSON.stringify(payload, null, 2)}`;
}
function buildResumeParsePrompt(params) {
    const payload = {
        task: 'RESUME_PARSE',
        base_profile: params.baseProfile ?? {},
...
function buildJobAnalyzePrompt(params) {
    const payload = {
...
function buildAutofillPlanPrompt(params) {
    const payload = {
